...
//         await db.run('INSERT INTO users (username, email, password, role, avatar, points, description) VALUES (?, ?, ?, ?, ?, ?, ?)', ['admin', 'admin@.com', defaultPassword, 'Admin', '/Blank profile.png', 1500, 'Chief Administrator of Forum.']);
//         await db.run('INSERT INTO posts (userId, title, question, tags, upvotes) VALUES (?, ?, ?, ?, ?)', [1, 'Welcome to Forum v2', 'This is the newly overhauled platform with proper authentication and real dynamic data. Let us know your thoughts.', JSON.stringify(['Announcement', 'Platform']), 10]);
//     }
//     return db;
// }
